...
public class OrderCalculationImpl implements OrderCalculation {
    ...
    private boolean regex(String s, String title) {
    ...
    private void checkPizzaAddonsCount() {
        for (int i = 3; i > 0; i--) {
            ...
            if (regex(readerText, "AddonsCount")) {
    ...
    private void checkPizzaAddonsEnum() {
        for (int i = 3; i > 0; i--) {
            ...
            if (regex(readerText, "PizzaAddons")) {
    ...
    private void checkDrinksNamesEnum() {
        for (int i = 3; i > 0; i--) {
            ...
            if (regex(readerText, "DrinksName")) {
    ...
    private void checkDrinksSizeEnum() {
        for (int i = 3; i > 0; i--) {
            ...
            if (regex(readerText, "DrinksSize")) {
